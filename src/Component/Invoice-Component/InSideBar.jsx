...
export default function SideBar({
  ...
  const menuItems = [
    { id: 'over-view', label: 'Overview', icon: <FiGrid size={18} />, to: '/cofdashboard' },
    { id: 'newrecords', label: 'New-Invoice', icon: <FiBox size={18} />, to: '/cofdashboard/new-records' },
    { id: 'CheckStocks', label: 'Invoice- History', icon: <FiFileText size={18} />, to: '/cofdashboard/new-records' },
