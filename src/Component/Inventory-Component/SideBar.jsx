...
export default function SideBar({
  ...
  const menuItems = [
    ...
    { id: 'settings', label: 'Settings', icon: <FiSettings size={18} />, to: '/cofdashboard/settings' },
    { id: 'help', label: 'Help & Support', icon: <FiHelpCircle size={18} />, to: '/cofdashboard/help' },
  ]
  ...
  return (
    <>
      ...
      >
        {/* stripe */}
        <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-r from-[#e4c723] to-[#9c8817]" />
                  ...
                  >
                    <Link
                      ...
                      className={`group flex items-center gap-3 w-full px-3 py-2 rounded-md transition-all ${
                        isActive
                          ? 'bg-gradient-to-r from-[#e4c723] to-[#9c8817] text-white shadow'
                          : 'text-amber-900'
                      }`}
                    >
                      <motion.span
                      ...
                      {isActive && (
                        <motion.div
                          className="ml-auto w-1 h-6 rounded-full bg-gradient-to-r from-[#e4c723] to-[#9c8817]"
